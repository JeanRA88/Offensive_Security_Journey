...
Detailed HTB and CTF writeups on my blog: **[heretek.dev](https://heretek.dev)**

### Recent (Active Directory focused)
- Shadow Credentials & ADCS ESC9 (Certified box)
- Kerberoasting & GPP Passwords (Active box)
- LSASS Dump & VSS Shadow Copies (Blackfield box)
- AS-REP Roasting & DCSync (Forest box)
- Azure AD Connect Exploit (Monteverde box)
- MSSQL Exploitation (Querier box)

## Tools

See my pentest toolkit repo: [pentest-toolkit](https://github.com/JeanRA88/pentest-toolkit)
